...
(function () {
    ...
    function Piechart(paper, cx, cy, r, values, opts) {
        ...
        if (len == 1) {
          ...
          //don't collapse small numbers! they matter, too! 
        ...
        //    });
            ...
            for (i = 0; i < len; i++) {
                ...
                var p = paper.path(opts.init ? ipath : path).attr({ fill: opts.colors && opts.colors[i] || chartinst.colors[i] || "#ff00ff", stroke: opts.stroke || "#fff", "stroke-width": (opts.strokewidth == null ? 1 : opts.strokewidth), "stroke-linejoin": "round" });
        ...
        var legend = function (labels, otherslabel, mark, dir) {
            var x = cx + r + r / 5, //moving legend to left 
                y = cy,
                h = y + 10;
